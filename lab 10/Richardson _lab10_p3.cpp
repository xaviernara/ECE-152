...
void older(date * input, int &dif)
{
	...
	for (int i = 0; i < 2; i++)
	{
		if (i == 0)
		{
			...
			cout << "day 1 is older and this is his/her birth day is  : " << input[i].day << " , " << input[i].year << ", " << input[i].month << endl;
		}
		if (i == 1)
		{
			dif2 = (input[i].month - tempdate.month) * 30 + (input[i].day - tempdate.day) * 1 + (input[i].year - tempdate.year) * 360;
			//cout << "day 2 is Greater";
			cout << "day 2 is older and this is his/her birth day is  : " << input[i].day << " , " << input[i].year << ", " << input[i].month << endl;
		}
		if (dif1 > dif2)
		{
			//greater = 0;
		...
		else if (dif2 > dif1)
		{
			...
			//start_dif = dif2;
			dif = dif2 - dif1;
			//cout << "day 2 is older and this is his/her birth day is  : " << dif1 << endl;
			//cout << "day 2 is Greater";
		}
	}
